                        ...
                        <div class="col-lg-6">
                            <div class="p-5">
                                <div class="text-center">
                                    <h1 class="h4 text-gray-900 mb-4">Twojego produktu nie ma w bazie. Dodaj produkt do bazy.</h1>
                                </div>
                                <hr>
                                <div class="text-center">
                                    <a class="small" href="addProduct">Dodaj produkt!</a>
                                </div>
                                <div class="text-center">
                                    <a class="small" href="/planMeals/Poniedziałek">Wróć do planowania posiłków.</a>
                                </div>
                                <%--                <!-- Page Heading -->--%>
